                        ...
                        >
                            ...
                            <div className="mt-4 sm:mt-6 px-1 sm:px-2 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-2 sm:pt-4">
                                    ...
                                    <Button className="w-full bg-[#2B2B2B] hover:bg-black text-white font-bold py-2 sm:py-6 text-[9px] sm:text-base rounded-full transition-all duration-300 active:scale-95 shadow-lg group-hover:shadow-[#00000033]">
                                        Buy Now
                                    </Button>
                                </div>
                            </div>
