                    ...
                    <form className="bg-gray-50 p-8 sm:p-12 rounded-[2.5rem] space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" className="w-full h-12 rounded-xl border border-gray-200 px-4 outline-none focus:border-brand-red transition-colors" placeholder="John Doe" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black uppercase tracking-widest text-gray-400">Email Address</label>
                                <input type="email" className="w-full h-12 rounded-xl border border-gray-200 px-4 outline-none focus:border-brand-red transition-colors" placeholder="john@example.com" />
                            </div>
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-400">Subject</label>
                            <input type="text" className="w-full h-12 rounded-xl border border-gray-200 px-4 outline-none focus:border-brand-red transition-colors" placeholder="Order Support" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-400">Message</label>
                            <textarea className="w-full h-32 rounded-xl border border-gray-200 p-4 outline-none focus:border-brand-red transition-colors resize-none" placeholder="Write your message here..."></textarea>
                        </div>
                        <button className="w-full h-14 bg-brand-black text-white rounded-full font-black uppercase tracking-widest hover:bg-brand-red transition-all duration-300">Send Message</button>
                    </form>
                </div>
            </main>
            <Footer />
